  ...
  export default {
    ...
    data() {
      return {
        ...
        ratings: [
          {
            category: "Best country so far:",
            winner: "THE UNITED STATES",
            others: ["Kazakhstan", "Malaysia", "UAE / Azerbaijan" , "Indonesia / Turkey", "Georgia"],
            image: "rating/usa.jpg",
          },
          {
            category: "Fastest-Growing Country:",
            winner: "Kazakhstan",
            others: ["UAE", "Indonesia", "Turkey" , "USA"],
            image: "rating/kaz.jpg",
          },
          {
            category: "Best city so far:",
            winner: "Kuala-Lumpur",
            others: ["Astana", "Baku", "Ocean city, NJ" , "Dubai"],
            image: "rating/kuala.jpg",
          },
          {
            category: "Best modern / new city:",
            winner: "Astana",
            others: ["Dubai", "Kuala-Lumpur", "Abu-Dhabi" , "New-York"],
            image: "rating/astana.jpg",
          },
          {
            category: "Less beautiful city:",
            winner: "Tbilisi",
            others: ["Istanbul"],
            image: "rating/tbilisi.jpg",
          },
          {
            category: "City with the best people:",
            winner: "Kuala-Lumpur",
            others: ["Denpasar, Bali", "Ocean city, NJ", "Karaganda",],
            image: "rating/kuala.jpg",
          },
        ],
      };
