...
data() {
  ...
  return {
    ...
    photos: [
      { src: `${baseURL}abudhabi/abudhabi1.webp`, title: "Photo 1", loading: true },
      { src: `${baseURL}abudhabi/abudhabi2.webp`, title: "Photo 2", loading: true },
      { src: `${baseURL}abudhabi/abudhabi7.webp`, title: "Photo 3", loading: true },
      { src: `${baseURL}abudhabi/abudhabi4.webp`, title: "Photo 4", loading: true },
      { src: `${baseURL}abudhabi/abudhabi5.webp`, title: "Photo 5", loading: true },
      { src: `${baseURL}abudhabi/abudhabi6.webp`, title: "Photo 6", loading: true },
      { src: `${baseURL}abudhabi/abudhabi3.webp`, title: "Photo 7", loading: true },
      { src: `${baseURL}abudhabi/abudhabi8.webp`, title: "Photo 8", loading: true },
      { src: `${baseURL}abudhabi/abudhabi9.webp`, title: "Photo 9", loading: true },
    ],
    selectedIndex: null,
    showScrollTop: false,
  };
